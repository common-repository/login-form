...
jQuery(document).ready(function() {
    ...
    jQuery("select[name='form-background-opacity']").change(function(){ 
        ...
        change_form_background_color(jQuery('[name=form-background-color]').val());

    });

    jQuery('[name=form-background-image]').change(function(){
        jQuery('.form_style').css('background-image', (this.value)?('url('+this.value+")"):'none' )}
    )

    jQuery('[name=form-logo-image]').change(function(){
            if (this.value) {
                jQuery('#lf_logo').attr('src', this.value);
                jQuery('#lf_logo').css('display', '');
            } else {
                jQuery('#lf_logo').css('display', 'none');
            }
    })
    ...
    jQuery('.prev_reset').click(function() { 
        ...
        jQuery(this).prev('input').prev('input').focus();
        jQuery(this).prev('input').prev('input').change();
        return false;
